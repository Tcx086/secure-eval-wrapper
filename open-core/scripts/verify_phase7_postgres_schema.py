...
"paper_market_data_evidence":{"market_evidence_id","series_identity_sha256","observation_id","evidence_sha256"},
...
"paper_order_projections":{"submission_id","latest_observation_id","authority_state","fill_application_complete"},
...
IMMUTABLE_TRIGGERS={"phase7_manifest_immutable","phase7_configuration_immutable","phase7_approval_delete_immutable","phase7_approval_update_guard","phase7_submission_delete_immutable","phase7_submission_update_guard","phase7_dispatch_update_guard","phase7_reservation_update_guard","phase7_cancel_update_guard","phase7_runtime_risk_immutable","phase7_approval_events_append_only","phase7_reservation_events_append_only","phase7_dispatch_events_append_only","phase7_orders_append_only","phase7_fills_append_only","phase7_run_terminal_guard","phase7_killed_switch_guard","phase7_order_budget_events_append_only","phase7_market_evidence_immutable","phase7_reconciliation_bundles_immutable","phase7_order_projection_guard","phase7_expiry_guard","phase7_paper_internal_venue_commands_append_only","phase7_paper_internal_venue_events_append_only","phase7_paper_venue_order_observations_append_only","phase7_paper_recovery_observation_bundles_append_only","phase7_paper_fill_recovery_lineage_append_only"}
def main():
