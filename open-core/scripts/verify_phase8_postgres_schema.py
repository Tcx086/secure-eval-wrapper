...
"live_preflight_sources":{"source_id","live_run_id","source_kind","source_sha256","operational","record_sha256"},
"live_preflight_reports":{"preflight_report_id","live_run_id","credential_reference_id","account_snapshot_id","status","record_sha256"},
...
"live_dispatch_outbox":{"dispatch_outbox_id","live_run_id","order_intent_id","state","provider_request_sha256","request_jsonb","claim_token","recovery_generation","version"},
...
"live_order_observations":{"order_observation_id","live_run_id","client_order_id","provider_response_sha256"},
...
"live_reconciliations":{"reconciliation_id","live_run_id","status","input_bundle_sha256","exact_input_jsonb"},
"live_reconciliation_differences":{"reconciliation_difference_id","reconciliation_id","live_run_id","material"},
"live_recovery_records":{"recovery_record_id","live_run_id","generation","claim_token","query_first","state","outcome","manual_intervention_required"},
...
INDEXES = {"idx_live_preflight_sources_run_kind","idx_live_risk_state_day","idx_live_reservation_balance","idx_live_dispatch_claimable","idx_live_recovery_claims"}
TRIGGERS = {"trg_guard_live_preflight_authority","trg_guard_live_manifest_chain","trg_live_approval_consumption","trg_live_intent_mutation","trg_live_dispatch_request_immutable","trg_live_cancel_request_immutable","trg_live_dispatch_monotonic","trg_live_reservation_monotonic","trg_live_projection_monotonic"}
