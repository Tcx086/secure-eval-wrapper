...
def create_live_manifest(*, configuration, report, approval, account_snapshot, credential_reference, repository_commit_sha: str, at_utc):
    preview = manifest_preview_hash(live_run_id=report.live_run_id, configuration=configuration, credential_reference_hash=credential_reference.record_hash, preflight_report_id=report.report_id, account_snapshot_hash=account_snapshot.record_hash, repository_commit_sha=repository_commit_sha)
