...
class PaperTradingEngine:
    ...
    def start(self,*,report,approval,snapshot,credential_reference,approval_controller:ApprovalController):
        ...
        approval_controller.validate(approval,paper_run_id=report.paper_run_id,report=report,configuration=self.configuration,snapshot=snapshot,credential_reference=credential_reference,at_utc=self.clock(),consume=True)
