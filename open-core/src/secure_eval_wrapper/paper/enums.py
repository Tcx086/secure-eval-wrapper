...
class PaperOrderState(str, Enum):
    PREPARED="prepared"; DISPATCH_CLAIMED="dispatch_claimed"; SUBMITTED="submitted"; PENDING_ACK="pending_ack"; ACKNOWLEDGED="acknowledged"; PARTIALLY_FILLED="partially_filled"; FILLED="filled"; CANCEL_REQUESTED="cancel_requested"; CANCEL_PENDING="cancel_pending"; CANCEL_UNKNOWN="cancel_unknown"; CANCELLED="cancelled"; REJECTED="rejected"; EXPIRED="expired"; SUBMISSION_UNKNOWN="submission_unknown"; PENDING_RECOVERY="pending_recovery"
...
class ReconciliationDifferenceType(str, Enum):
    LOCAL_ORDER_MISSING_AT_VENUE="local_order_missing_at_venue"; VENUE_ORDER_MISSING_LOCALLY="venue_order_missing_locally"; ORDER_STATUS_MISMATCH="order_status_mismatch"; VENUE_ORDER_ID_MISMATCH="venue_order_id_mismatch"; QUANTITY_MISMATCH="quantity_mismatch"; FILL_MISSING_LOCALLY="fill_missing_locally"; FILL_MISSING_AT_VENUE="fill_missing_at_venue"; DUPLICATE_FILL="duplicate_fill"; BALANCE_MISMATCH="balance_mismatch"; BALANCE_AVAILABILITY_MISMATCH="balance_availability_mismatch"; RESERVATION_MISMATCH="reservation_mismatch"; POSITION_MISMATCH="position_mismatch"; REALIZED_PNL_MISMATCH="realized_pnl_mismatch"; FEE_MISMATCH="fee_mismatch"; CURRENCY_MISMATCH="currency_mismatch"; STALE_VENUE_SNAPSHOT="stale_venue_snapshot"; STALE_LOCAL_SNAPSHOT="stale_local_snapshot"; SEQUENCE_GAP="sequence_gap"; UNKNOWN_SUBMISSION="unknown_submission"; CANCEL_PENDING="cancel_pending"; UNSUPPORTED_VENUE_FIELD="unsupported_venue_field"; ACCOUNT_MODE_MISMATCH="account_mode_mismatch"; RESERVATION_AUTHORITY_MISMATCH="reservation_authority_mismatch"; ORDER_BUDGET_MISMATCH="order_budget_mismatch"; VENUE_EVENT_SEQUENCE_MISMATCH="venue_event_sequence_mismatch"; LATEST_OBSERVATION_MISMATCH="latest_observation_mismatch"; FILL_APPLICATION_INCOMPLETE="fill_application_incomplete"
